...
/obj/structure/machinery/cm_vending/sorted/cargo_guns/LateInitialize()
...
/obj/structure/machinery/cm_vending/sorted/cargo_guns/populate_product_list(var/scale)
	if(IS_DAMAGE_ACTION_MODE)
		listed_products = list(
			list("PRIMARY FIREARMS", -1, null, null, null),
			list("CZ-81 Machine Pistol", round(scale * 15), /obj/item/weapon/gun/pistol/skorpion/upp, VENDOR_ITEM_REGULAR),
			list("Type 71 Pulse Rifle", round(scale * 20), /obj/item/weapon/gun/rifle/type71, VENDOR_ITEM_REGULAR),
			list("Type 71 Pulse Rifle Carbine", round(scale * 20), /obj/item/weapon/gun/rifle/type71/carbine, VENDOR_ITEM_REGULAR),

			list("SIDEARMS", -1, null, null, null),
			list("Highpower Automag", round(scale * 20), /obj/item/weapon/gun/pistol/highpower, VENDOR_ITEM_REGULAR),
			list("Korovin PK-9 Pistol", round(scale * 20), /obj/item/weapon/gun/pistol/c99/upp, VENDOR_ITEM_REGULAR),
			list("N-Y 7.62mm Revolver", round(scale * 20), /obj/item/weapon/gun/revolver/nagant, VENDOR_ITEM_REGULAR),

			list("EXPLOSIVES", -1, null, null, null),
			list("Plastic Explosive", round(scale * 3), /obj/item/explosive/plastic, VENDOR_ITEM_REGULAR),
			list("Breaching Charge", round(scale * 3), /obj/item/explosive/plastic/breaching_charge, VENDOR_ITEM_REGULAR),
			list("Smoke Grenade", round(scale * 5), /obj/item/explosive/grenade/smokebomb, VENDOR_ITEM_REGULAR),
			list("Type 6 Shrapnel Grenade", round(scale * 3), /obj/item/explosive/grenade/HE/upp, VENDOR_ITEM_REGULAR),
			list("Type 8 WP Grenade", round(scale * 3), /obj/item/explosive/grenade/phosphorus/upp, VENDOR_ITEM_REGULAR),
...
/obj/structure/machinery/cm_vending/sorted/uniform_supply/Initialize()
	..()
	return INITIALIZE_HINT_ROUNDSTART

/obj/structure/machinery/cm_vending/sorted/uniform_supply/LateInitialize()
	if(IS_DAMAGE_ACTION_MODE)
		name = replacetext(name, "ColMarTech", "Norcomm")
		vendor_theme = VENDOR_THEME_UPP
		listed_products = list(
			...
			list("Combat Boots", 20, /obj/item/clothing/shoes/marine/upp, VENDOR_ITEM_REGULAR),
			list("M276 Ammo Load Rig", 10, /obj/item/storage/belt/marine, VENDOR_ITEM_REGULAR),
			list("M276 Shotgun Shell Loading Rig", 10, /obj/item/storage/belt/shotgun, VENDOR_ITEM_REGULAR),
			list("UPP Fatigues", 20, /obj/item/clothing/under/marine/veteran/UPP, VENDOR_ITEM_REGULAR),

			list("ARMOR", -1, null, null),
			list("UM4 Helmet", 40, /obj/item/clothing/head/helmet/marine/veteran/UPP, VENDOR_ITEM_REGULAR),
			list("UM5 Personal Armor", 40, /obj/item/clothing/suit/storage/marine/faction/UPP, VENDOR_ITEM_REGULAR),

			list("GLOVES", -1, null, null),
			list("Combat Gloves", 40, /obj/item/clothing/gloves/marine/veteran, VENDOR_ITEM_REGULAR),

			list("RADIO", -1, null, null),
			list("Radio Encryption Key", 5, /obj/item/device/radio/headset/distress/UPP, VENDOR_ITEM_REGULAR),
			list("CCT Radio Encryption Key", 5, /obj/item/device/radio/headset/distress/UPP/cct, VENDOR_ITEM_REGULAR),

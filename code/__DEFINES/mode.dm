...
var/global/list/ROLES_DAMAGE_ACTION = list(
	JOB_UPP_KOL_OFFICER, JOB_UPP_COMBAT_SYNTH, JOB_UPP_MAY_OFFICER, JOB_UPP_SRLT_OFFICER, JOB_UPP_CREWMAN, JOB_UPP_POLICE, JOB_WO_PILOT, JOB_WO_CHIEF_REQUISITION, \
	JOB_WO_CMO, JOB_UPP_LT_DOKTOR, JOB_WO_RESEARCHER, JOB_WO_CHIEF_ENGINEER, JOB_WO_ORDNANCE_TECH, JOB_WO_REQUISITION, JOB_UPP_REPRESENTATIVE, JOB_UPP_LEADER, \
	JOB_UPP_SPECIALIST_SHOTGUNNER, JOB_UPP_SPECIALIST_MINIGUNNER, JOB_UPP_MEDIC, JOB_UPP_ENGI, JOB_UPP_RTO, JOB_UPP
) + ROLES_SPECIAL + ROLES_WHITELISTED + ROLES_XENO
